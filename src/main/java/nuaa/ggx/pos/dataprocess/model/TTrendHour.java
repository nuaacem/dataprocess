 ...
 */
@Entity
@Table(name = "t_trend_hour", catalog = "nuaacempos")
public class TTrendHour implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4398170248007851711L;
	// Fields
